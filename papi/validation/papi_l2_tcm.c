/* This code runs some sanity checks on the PAPI_L2_TCM */
/*   (L2 Total Cache Misses) count.                     */
...
int main(int argc, char **argv) {
   ...
   char test_string[]="Testing PAPI_L2_TCM predefined event...";
   ...
   if (retval != PAPI_OK) {
      if (!quiet) printf("PAPI_L2_TCM not available\n");
