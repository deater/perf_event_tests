...
/* schedules it if available.  If the NMI watchdog is available */
/* it probably grabs it, making the test somewhat useless */
...
int main(int argc, char **argv) {
	...
	if (!quiet) {
		...
		printf("and the NMI watchdog ofen steals the fixed one.\n");
